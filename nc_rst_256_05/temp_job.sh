...
# Run the program:
srun !!EXECUTABLE!! -i !!INPUTFILE!! problem/turbulence/rescale_once_on_restart=true -r /ptmp/mpa/ankitad/athenapk/nc_256_05/parthenon.restart.final.rhdf > !!JOBNAME!!.out
